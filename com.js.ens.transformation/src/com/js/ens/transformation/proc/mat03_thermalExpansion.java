...
public class mat03_thermalExpansion {
	...
	public void running(String type, String standType){
		...
		if(this.type.equals("constant")){
			...
			new_filePath = myUtil.setPath(myUtil.setPath(myUtil.setPath(MC.getWorkspace(), "proc"),standType),this.FileName_mat03Con);
		}else {
			ori_filePath = myUtil.setPath(myUtil.setPath(modulePath, standType), this.FileName_mat03Tbl);
			new_filePath = myUtil.setPath(myUtil.setPath(myUtil.setPath(MC.getWorkspace(), "proc"),standType),this.FileName_mat03Tbl);
		}
