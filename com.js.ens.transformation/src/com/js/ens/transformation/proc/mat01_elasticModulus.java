...
public class mat01_elasticModulus {
	...
	public void running(String type, String standType){	//Constant || Table
		...
		if(this.type.equals("constant")){
			...
			new_filePath = myUtil.setPath(myUtil.setPath(myUtil.setPath(MC.getWorkspace(), "proc"),standType),this.FileName_mat01Con);
		}else {
			ori_filePath = myUtil.setPath(myUtil.setPath(modulePath, standType), this.FileName_mat01Tbl);
			new_filePath = myUtil.setPath(myUtil.setPath(myUtil.setPath(MC.getWorkspace(), "proc"),standType),this.FileName_mat01Tbl);
		}
