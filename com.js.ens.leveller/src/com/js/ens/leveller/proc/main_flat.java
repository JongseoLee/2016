...
public class main_flat {
	...
	public void running(){
		try{
			procFilePath = myUtil.setPath(myUtil.setPath(LMain.getWorkspace(), "proc"), "main_flat.proc");
	...
	public void readSourceData() throws Exception{
		...
		String sourcePath = myUtil.setPath(s_folder, "main_flat.proc");
