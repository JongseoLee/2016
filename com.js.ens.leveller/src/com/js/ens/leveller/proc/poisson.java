...
public class poisson {
	private Logger log = Logger.getLogger(poisson.class);
	...
	public poisson(String value_poisson){
	...
	public void running(){
		try{
			procFilePath = myUtil.setPath(myUtil.setPath(LMain.getWorkspace(),"proc"),"mat04_poisson.proc");
	...
	public void readSourceData() throws Exception{
		Reader reader = new Reader(this.value_poisson);
		reader.running();
	...
	public void readSourceData2() throws Exception{
		...
		String sourcePath = myUtil.setPath(s_folder, "mat04_poisson.proc");
