...
public class main_islandGutter {
	...
	public main_islandGutter(String path){
	...
	public void running(){
		...
		try{
			procFilePath = myUtil.setPath(myUtil.setPath(LMain.getWorkspace(), "proc"), "main_islandgutter.proc");
			...
			DPObj.running();
			// m1_flat_proc
			m1_islandGutter M1FObj = new m1_islandGutter();
			M1FObj.running();
			// a2_roll_gen~~~
	...
	public void readSourceData() throws Exception{
		...
		String sourcePath = myUtil.setPath(s_folder, "main_islandgutter.proc");
