...
public class main_centerWave {
	...
	public main_centerWave(String path){
	...
	public void running(){
		try{
			// 실제 사용 
			procFilePath = myUtil.setPath(myUtil.setPath(LMain.getWorkspace(), "proc"), "main_centerwave.proc");
			...
			DPObj.running();
			// m1_flat_proc
			m1_centerWave M1FObj = new m1_centerWave();
			M1FObj.running();
			// a2_roll_gen~~~
	...
	public void readSourceData() throws Exception{
		...
		String sourcePath = myUtil.setPath(s_folder, "main_centerwave.proc");
