...
public class main_edgeWave {
	...
	public main_edgeWave(String path){
	...
	public void running(){
		try{
			// 실제 사용 
			procFilePath = myUtil.setPath(myUtil.setPath(LMain.getWorkspace(), "proc"), "main_edgewave.proc");
			...
			DPObj.running();
			// m1_flat_proc
			m1_edgeWave M1FObj = new m1_edgeWave();
			M1FObj.running();
			// a2_roll_gen~~~
	...
	public void readSourceData() throws Exception{
		...
		String sourcePath = myUtil.setPath(s_folder, "main_edgewave.proc");
