...
public class ApplyConfirm_2DDlg extends Dialog {
	 ...
	 * @param parentShell
	 */
	public ApplyConfirm_2DDlg(Shell parentShell) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		lblDoYouExort.setText("Do you Save db file and export procedure file?");
