			...
			public void widgetSelected(SelectionEvent e) {
				try {
					if(LMain.getWorkspace() != null){
						ChartViewer window = new ChartViewer(myUtil.setPath(LMain.getWorkspace(), "result"));
						window.open();
					}else{
			...
			public void widgetSelected(SelectionEvent e) {
				...
				final SwingWorker<String, Void> worker = new SwingWorker<String, Void>() {
					...
					protected String doInBackground() throws Exception {
						...
						if(LMain.getWorkspace() != null){
							ImageViewer viewer = new ImageViewer(myUtil.setPath(LMain.getWorkspace(), "result"));
