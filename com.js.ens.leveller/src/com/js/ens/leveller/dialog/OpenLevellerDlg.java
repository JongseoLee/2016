...
public class OpenLevellerDlg extends Dialog {
	 ...
	 * @param parentShell
	 */
	public OpenLevellerDlg(Shell parentShell) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		lblSelectLevelerDb.setText("Select Leveler DB File");
		...
		buttonExplorer.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				//String [] extType = {"*.rtl"};
				String [] extNames = {"Leveller DB(*.lvdb)"};
				String [] extType = {"*.lvdb"};
	...
	public void OpenLeveller(){
		LMain.OpenLeveller(DBFilePath);
	}
}
