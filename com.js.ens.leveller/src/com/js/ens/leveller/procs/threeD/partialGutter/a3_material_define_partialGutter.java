...
import com.js.ens.leveller.procs.threeD.partialGutter.mat01_elastic_modulus_const_partialGutter;
import com.js.ens.leveller.procs.threeD.partialGutter.mat01_elastic_modulus_partialGutter;
import com.js.ens.leveller.procs.threeD.partialGutter.mat02_flow_stress_const_partialGutter;
import com.js.ens.leveller.procs.threeD.partialGutter.mat02_flow_stress_partialGutter;
import com.js.ens.leveller.procs.threeD.partialGutter.mat03_thermal_expansion_const_partialGutter;
import com.js.ens.leveller.procs.threeD.partialGutter.mat03_thermal_expansion_partialGutter;
import com.js.ens.leveller.procs.threeD.partialGutter.mat04_poisson_const_partialGutter;
import com.js.ens.leveller.procs.threeD.partialGutter.mat04_poisson_partialGutter;
import com.js.ens.leveller.procs.threeD.partialGutter.mat05_mass_density_partialGutter;
import com.js.io.Reader;
import com.js.io.Writer;
import com.js.util.myUtil;

public class a3_material_define_partialGutter {
	private Logger log = Logger.getLogger(a3_material_define_partialGutter.class);
	...
	public a3_material_define_partialGutter() {
	...
	private void genMatProc() {
		...
		if(LMain.getYoungsModulusType().toLowerCase().equals("constant")){
			mat01_elastic_modulus_const_partialGutter EMObj = new mat01_elastic_modulus_const_partialGutter();
		...
		//mat01_~_const.proc
			...
			mat01_elastic_modulus_partialGutter EMObj = new mat01_elastic_modulus_partialGutter();
		...
		if(LMain.getFlowStressType().toLowerCase().equals("constant")){
			mat02_flow_stress_const_partialGutter FSObj = new mat02_flow_stress_const_partialGutter();
		...
		//mat02_~_const.proc
			...
			mat02_flow_stress_partialGutter FSObj = new mat02_flow_stress_partialGutter();
		...
		if(LMain.getThermalExpansionCoefficientType().toLowerCase().equals("constant")){
			mat03_thermal_expansion_const_partialGutter TECObj = new mat03_thermal_expansion_const_partialGutter();
		...
		//mat03_~_const.proc
			...
			mat03_thermal_expansion_partialGutter TECObj = new mat03_thermal_expansion_partialGutter();
		...
		if (LMain.getPoissonsRatioType().toLowerCase().equals("constant")) {
			mat04_poisson_const_partialGutter PObj = new mat04_poisson_const_partialGutter();
		...
		//mat04_~_const.proc
			...
			mat04_poisson_partialGutter PObj = new mat04_poisson_partialGutter();
		...
		//mat05_~proc
		mat05_mass_density_partialGutter MDObj = new mat05_mass_density_partialGutter();
