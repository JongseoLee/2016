...
public class a2_roll_gen_islandGutter {

	private Logger log = Logger.getLogger(a2_roll_gen_islandGutter.class);
	...
	public a2_roll_gen_islandGutter() {
		...
		for(String line : fileDataList){
			if(line.contains(ProcMaker.upperRollGenField)){
				...
				if( Integer.parseInt(LMain.getSpinnerUpperRollNum()) <= Integer.parseInt(LMain.getSpinnerLowerRollNum()) ){
					...
					procDataList.add("point(fdist+rdist+roll_dia/2+roll_pitch*("+lastNum+")+roll_dia/2 - roll_dia/2, -roll_dia/2, -1000)");
					procDataList.add("point(fdist+rdist+roll_dia/2+roll_pitch*("+lastNum+")+roll_dia/2, 0, -1000)");
					procDataList.add("point(fdist+rdist+roll_dia/2+roll_pitch*("+lastNum+")+roll_dia/2, 0, -1000)");
					procDataList.add("point(fdist+rdist+roll_dia/2+roll_pitch*("+lastNum+")+roll_dia/2 + L + 5000, 0, -1000)");
				}else{
