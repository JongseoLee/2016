...
import com.js.ens.leveller.procs.threeD.centerWave.a2_roll_gen_centerWave;
import com.js.ens.leveller.procs.threeD.centerWave.a3_material_define_centerWave;
import com.js.ens.leveller.procs.threeD.centerWave.a4_contact_centerWave;
import com.js.ens.leveller.procs.threeD.centerWave.a6_loadcase_centerWave;
import com.js.ens.leveller.procs.threeD.centerWave.define_parameters_centerWave;
import com.js.io.Reader;
import com.js.io.Writer;

public class Main_centerwave {
	private Logger log = Logger.getLogger(Main_centerwave.class);
	private LevellerMain LMain = LevellerMain.getInstatnce();
	
	private ArrayList<String> filePathList = new ArrayList<String>();
	private String main_centerwave_Path					= "";
	...
	public void running(ArrayList<String> destFullPath){
		...
		try{
			...
			this.swapValue();
			this.writeProc();
			LMain.getExportMSG().addData("SUCCESS - Export(main_centerWave) \n path : "+ this.main_centerwave_Path);
			log.info("SUCCESS - Export(main_centerWave) \n path : "+ this.main_centerwave_Path);
			
			this.GenOtherProcs();
		}catch(Exception e){
			String msg = "ERROR - Export(main_centerWave)";
			msg = msg +"\n"+e.getMessage();
	...
	private void setFilesPath() throws Exception{
		for(String path : this.filePathList){
			if(path.contains("main_centerwave.proc")){
				this.main_centerwave_Path = path.trim();
	...
	private void readSourceData() throws Exception{
		...
		Reader reader = new Reader(this.main_centerwave_Path);
		reader.running();
	...
	private void writeProc() throws Exception{
		Writer writer = new Writer(this.main_centerwave_Path,this.procDataList);
		writer.running();
	}
	...
	private void GenOtherProcs(){
		...
		define_parameters_centerWave DPObj = new define_parameters_centerWave();
		DPObj.running(this.define_parameters_PATH);
		//a2_roll_gen.proc
		a2_roll_gen_centerWave a2Obj = new a2_roll_gen_centerWave();
		a2Obj.running(this.a2_roll_gen_PATH);
		//a3_material_define.proc
		a3_material_define_centerWave a3Obj = new a3_material_define_centerWave();
		a3Obj.running(this.a3_material_define_PATH, matsPath);
		//a4_contact.proc
		a4_contact_centerWave a4Obj = new a4_contact_centerWave();
		a4Obj.running(this.a4_contact_PATH);
		//a6_loadcase.proc
		a6_loadcase_centerWave a6Obj = new a6_loadcase_centerWave();
