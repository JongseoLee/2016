...
import com.js.ens.leveller.procs.threeD.centerWave.mat01_elastic_modulus_const_centerWave;
import com.js.ens.leveller.procs.threeD.centerWave.mat01_elastic_modulus_centerWave;
import com.js.ens.leveller.procs.threeD.centerWave.mat02_flow_stress_const_centerWave;
import com.js.ens.leveller.procs.threeD.centerWave.mat02_flow_stress_centerWave;
import com.js.ens.leveller.procs.threeD.centerWave.mat03_thermal_expansion_const_centerWave;
import com.js.ens.leveller.procs.threeD.centerWave.mat03_thermal_expansion_centerWave;
import com.js.ens.leveller.procs.threeD.centerWave.mat04_poisson_const_centerWave;
import com.js.ens.leveller.procs.threeD.centerWave.mat04_poisson_centerWave;
import com.js.ens.leveller.procs.threeD.centerWave.mat05_mass_density_centerWave;
import com.js.io.Reader;
import com.js.io.Writer;
import com.js.util.myUtil;

public class a3_material_define_centerWave {
	private Logger log = Logger.getLogger(a3_material_define_centerWave.class);
	...
	public a3_material_define_centerWave() {
	...
	private void genMatProc() {
		...
		if(LMain.getYoungsModulusType().toLowerCase().equals("constant")){
			mat01_elastic_modulus_const_centerWave EMObj = new mat01_elastic_modulus_const_centerWave();
		...
		//mat01_~_const.proc
			...
			mat01_elastic_modulus_centerWave EMObj = new mat01_elastic_modulus_centerWave();
		...
		if(LMain.getFlowStressType().toLowerCase().equals("constant")){
			mat02_flow_stress_const_centerWave FSObj = new mat02_flow_stress_const_centerWave();
		...
		//mat02_~_const.proc
			...
			mat02_flow_stress_centerWave FSObj = new mat02_flow_stress_centerWave();
		...
		if(LMain.getThermalExpansionCoefficientType().toLowerCase().equals("constant")){
			mat03_thermal_expansion_const_centerWave TECObj = new mat03_thermal_expansion_const_centerWave();
		...
		//mat03_~_const.proc
			...
			mat03_thermal_expansion_centerWave TECObj = new mat03_thermal_expansion_centerWave();
		...
		if (LMain.getPoissonsRatioType().toLowerCase().equals("constant")) {
			mat04_poisson_const_centerWave PObj = new mat04_poisson_const_centerWave();
		...
		//mat04_~_const.proc
			...
			mat04_poisson_centerWave PObj = new mat04_poisson_centerWave();
		...
		//mat05_~proc
		mat05_mass_density_centerWave MDObj = new mat05_mass_density_centerWave();
