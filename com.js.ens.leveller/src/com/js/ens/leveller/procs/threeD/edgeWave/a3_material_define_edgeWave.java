...
import com.js.ens.leveller.procs.threeD.edgeWave.mat01_elastic_modulus_const_edgeWave;
import com.js.ens.leveller.procs.threeD.edgeWave.mat01_elastic_modulus_edgeWave;
import com.js.ens.leveller.procs.threeD.edgeWave.mat02_flow_stress_const_edgeWave;
import com.js.ens.leveller.procs.threeD.edgeWave.mat02_flow_stress_edgeWave;
import com.js.ens.leveller.procs.threeD.edgeWave.mat03_thermal_expansion_const_edgeWave;
import com.js.ens.leveller.procs.threeD.edgeWave.mat03_thermal_expansion_edgeWave;
import com.js.ens.leveller.procs.threeD.edgeWave.mat04_poisson_const_edgeWave;
import com.js.ens.leveller.procs.threeD.edgeWave.mat04_poisson_edgeWave;
import com.js.ens.leveller.procs.threeD.edgeWave.mat05_mass_density_edgeWave;
import com.js.io.Reader;
import com.js.io.Writer;
import com.js.util.myUtil;

public class a3_material_define_edgeWave {
	private Logger log = Logger.getLogger(a3_material_define_edgeWave.class);
	...
	public a3_material_define_edgeWave() {
	...
	private void genMatProc() {
		...
		if(LMain.getYoungsModulusType().toLowerCase().equals("constant")){
			mat01_elastic_modulus_const_edgeWave EMObj = new mat01_elastic_modulus_const_edgeWave();
		...
		//mat01_~_const.proc
			...
			mat01_elastic_modulus_edgeWave EMObj = new mat01_elastic_modulus_edgeWave();
		...
		if(LMain.getFlowStressType().toLowerCase().equals("constant")){
			mat02_flow_stress_const_edgeWave FSObj = new mat02_flow_stress_const_edgeWave();
		...
		//mat02_~_const.proc
			...
			mat02_flow_stress_edgeWave FSObj = new mat02_flow_stress_edgeWave();
		...
		if(LMain.getThermalExpansionCoefficientType().toLowerCase().equals("constant")){
			mat03_thermal_expansion_const_edgeWave TECObj = new mat03_thermal_expansion_const_edgeWave();
		...
		//mat03_~_const.proc
			...
			mat03_thermal_expansion_edgeWave TECObj = new mat03_thermal_expansion_edgeWave();
		...
		if (LMain.getPoissonsRatioType().toLowerCase().equals("constant")) {
			mat04_poisson_const_edgeWave PObj = new mat04_poisson_const_edgeWave();
		...
		//mat04_~_const.proc
			...
			mat04_poisson_edgeWave PObj = new mat04_poisson_edgeWave();
		...
		//mat05_~proc
		mat05_mass_density_edgeWave MDObj = new mat05_mass_density_edgeWave();
