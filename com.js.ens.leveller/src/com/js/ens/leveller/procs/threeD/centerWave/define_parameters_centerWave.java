...
public class define_parameters_centerWave {
	private Logger log = Logger.getLogger(define_parameters_centerWave.class);
	...
	public define_parameters_centerWave() {
	...
	private void swapValue() throws Exception{
		...
		for(String line : fileDataList){
			...
			else if(line.contains(ProcMaker.type3_textWavePitch)){
