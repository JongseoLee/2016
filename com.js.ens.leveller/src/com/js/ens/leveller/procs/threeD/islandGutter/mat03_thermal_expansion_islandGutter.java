...
public class mat03_thermal_expansion_islandGutter {

	private Logger log = Logger.getLogger(mat03_thermal_expansion_islandGutter.class);
	...
	public mat03_thermal_expansion_islandGutter() {
