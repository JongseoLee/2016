...
import com.js.ens.leveller.procs.threeD.doubleGutter.a2_roll_gen_doubleGutter;
import com.js.ens.leveller.procs.threeD.doubleGutter.a3_material_define_doubleGutter;
import com.js.ens.leveller.procs.threeD.doubleGutter.a4_contact_doubleGutter;
import com.js.ens.leveller.procs.threeD.doubleGutter.a6_loadcase_doubleGutter;
import com.js.ens.leveller.procs.threeD.doubleGutter.define_parameters_doubleGutter;
import com.js.io.Reader;
import com.js.io.Writer;

public class Main_doublegutter {
	private Logger log = Logger.getLogger(Main_doublegutter.class);
	private LevellerMain LMain = LevellerMain.getInstatnce();
	
	private ArrayList<String> filePathList = new ArrayList<String>();
	private String main_doublegutter_Path 				= "";
	...
	public void running(ArrayList<String> destFullPath){
		...
		try{
			...
			LMain.getExportMSG().addData("SUCCESS - Export(main_doublegutter) \n path : "+ this.main_doublegutter_Path);
			log.info("SUCCESS - Export(main_doublegutter) \n path : "+ this.main_doublegutter_Path);
	...
	private void writeProc() throws Exception{
		Writer writer = new Writer(this.main_doublegutter_Path,this.procDataList);
		writer.running();
	}
	...
	private void GenOtherProcs(){
		...
		define_parameters_doubleGutter DPObj = new define_parameters_doubleGutter();
		DPObj.running(this.define_parameters_PATH);
		//a2_roll_gen.proc
		a2_roll_gen_doubleGutter a2Obj = new a2_roll_gen_doubleGutter();
		a2Obj.running(this.a2_roll_gen_PATH);
		//a3_material_define.proc
		a3_material_define_doubleGutter a3Obj = new a3_material_define_doubleGutter();
		a3Obj.running(this.a3_material_define_PATH, matsPath);
		//a4_contact.proc
		a4_contact_doubleGutter a4Obj = new a4_contact_doubleGutter();
		a4Obj.running(this.a4_contact_PATH);
		//a6_loadcase.proc
		a6_loadcase_doubleGutter a6Obj = new a6_loadcase_doubleGutter();
