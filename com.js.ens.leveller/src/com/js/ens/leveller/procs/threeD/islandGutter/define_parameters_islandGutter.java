...
public class define_parameters_islandGutter {

	private Logger log = Logger.getLogger(define_parameters_islandGutter.class);
	...
	public define_parameters_islandGutter() {
	...
	private void swapValue() throws Exception{
		...
		for(String line : fileDataList){
			...
			else if(line.contains(ProcMaker.type7_textHeadGutterHeight)){
