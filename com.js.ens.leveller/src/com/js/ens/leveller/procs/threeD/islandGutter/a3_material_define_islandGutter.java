package com.js.ens.leveller.procs.threeD.islandGutter;
...
import com.js.ens.leveller.procs.threeD.islandGutter.mat01_elastic_modulus_const_islandGutter;
import com.js.ens.leveller.procs.threeD.islandGutter.mat01_elastic_modulus_islandGutter;
import com.js.ens.leveller.procs.threeD.islandGutter.mat02_flow_stress_const_islandGutter;
import com.js.ens.leveller.procs.threeD.islandGutter.mat02_flow_stress_islandGutter;
import com.js.ens.leveller.procs.threeD.islandGutter.mat03_thermal_expansion_const_islandGutter;
import com.js.ens.leveller.procs.threeD.islandGutter.mat03_thermal_expansion_islandGutter;
import com.js.ens.leveller.procs.threeD.islandGutter.mat04_poisson_const_islandGutter;
import com.js.ens.leveller.procs.threeD.islandGutter.mat04_poisson_islandGutter;
import com.js.ens.leveller.procs.threeD.islandGutter.mat05_mass_density_islandGutter;
import com.js.io.Reader;
import com.js.io.Writer;
import com.js.util.myUtil;

public class a3_material_define_islandGutter {

	private Logger log = Logger.getLogger(a3_material_define_islandGutter.class);
	...
	public a3_material_define_islandGutter() {
	...
	private void genMatProc() {
		...
		if(LMain.getYoungsModulusType().toLowerCase().equals("constant")){
			mat01_elastic_modulus_const_islandGutter EMObj = new mat01_elastic_modulus_const_islandGutter();
		...
		//mat01_~_const.proc
			...
			mat01_elastic_modulus_islandGutter EMObj = new mat01_elastic_modulus_islandGutter();
		...
		if(LMain.getFlowStressType().toLowerCase().equals("constant")){
			mat02_flow_stress_const_islandGutter FSObj = new mat02_flow_stress_const_islandGutter();
		...
		//mat02_~_const.proc
			...
			mat02_flow_stress_islandGutter FSObj = new mat02_flow_stress_islandGutter();
		...
		if(LMain.getThermalExpansionCoefficientType().toLowerCase().equals("constant")){
			mat03_thermal_expansion_const_islandGutter TECObj = new mat03_thermal_expansion_const_islandGutter();
		...
		//mat03_~_const.proc
			...
			mat03_thermal_expansion_islandGutter TECObj = new mat03_thermal_expansion_islandGutter();
		...
		if (LMain.getPoissonsRatioType().toLowerCase().equals("constant")) {
			mat04_poisson_const_islandGutter PObj = new mat04_poisson_const_islandGutter();
		...
		//mat04_~_const.proc
			...
			mat04_poisson_islandGutter PObj = new mat04_poisson_islandGutter();
		...
		//mat05_~proc
		mat05_mass_density_islandGutter MDObj = new mat05_mass_density_islandGutter();
