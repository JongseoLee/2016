...
import com.js.ens.leveller.procs.threeD.islandGutter.a2_roll_gen_islandGutter;
import com.js.ens.leveller.procs.threeD.islandGutter.a3_material_define_islandGutter;
import com.js.ens.leveller.procs.threeD.islandGutter.a4_contact_islandGutter;
import com.js.ens.leveller.procs.threeD.islandGutter.a6_loadcase_islandGutter;
import com.js.ens.leveller.procs.threeD.islandGutter.define_parameters_islandGutter;
import com.js.io.Reader;
import com.js.io.Writer;

public class Main_islandgutter {
	private Logger log = Logger.getLogger(Main_islandgutter.class);
	private LevellerMain LMain = LevellerMain.getInstatnce();
	
	private ArrayList<String> filePathList = new ArrayList<String>();
	private String main_islandgutter_Path 				= "";
	...
	public void running(ArrayList<String> destFullPath){
		...
		try{
			...
			LMain.getExportMSG().addData("SUCCESS - Export(main_islandgutter) \n path : "+ this.main_islandgutter_Path);
			log.info("SUCCESS - Export(main_islandgutter) \n path : "+ this.main_islandgutter_Path);
			
			this.GenOtherProcs();
			
		}catch(Exception e){
			String msg = "ERROR - Export(main_islandgutter)";
			msg = msg +"\n"+e.getMessage();
	...
	private void setFilesPath() throws Exception{
		for(String path : this.filePathList){
			if(path.contains("main_islandgutter.proc")){
				this.main_islandgutter_Path = path.trim();
	...
	private void readSourceData() throws Exception{
		...
		Reader reader = new Reader(this.main_islandgutter_Path);
		reader.running();
	...
	private void writeProc() throws Exception{
		Writer writer = new Writer(this.main_islandgutter_Path,this.procDataList);
		writer.running();
	}
	...
	private void GenOtherProcs(){
		...
		define_parameters_islandGutter DPObj = new define_parameters_islandGutter();
		DPObj.running(this.define_parameters_PATH);
		//a2_roll_gen.proc
		a2_roll_gen_islandGutter a2Obj = new a2_roll_gen_islandGutter();
		a2Obj.running(this.a2_roll_gen_PATH);
		//a3_material_define.proc
		a3_material_define_islandGutter a3Obj = new a3_material_define_islandGutter();
		a3Obj.running(this.a3_material_define_PATH, matsPath);
		//a4_contact.proc
		a4_contact_islandGutter a4Obj = new a4_contact_islandGutter();
		a4Obj.running(this.a4_contact_PATH);
		//a6_loadcase.proc
		a6_loadcase_islandGutter a6Obj = new a6_loadcase_islandGutter();
