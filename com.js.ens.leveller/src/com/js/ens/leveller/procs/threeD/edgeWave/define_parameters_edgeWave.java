...
public class define_parameters_edgeWave {
	private Logger log = Logger.getLogger(define_parameters_edgeWave.class);
	...
	public define_parameters_edgeWave() {
	...
	private void swapValue() throws Exception{
		...
		for(String line : fileDataList){
			...
			else if(line.contains(ProcMaker.type2_textLeftEdgeWavePitch)){
