...
public class define_parameters_singleGutter {
	private Logger log = Logger.getLogger(define_parameters_singleGutter.class);
	...
	public define_parameters_singleGutter() {
	...
	private void swapValue() throws Exception{
		...
		for(String line : fileDataList){
			...
			else if(line.contains(ProcMaker.type4_textGutterHeight)){
