...
import com.js.ens.leveller.procs.threeD.singleGutter.mat01_elastic_modulus_const_singleGutter;
import com.js.ens.leveller.procs.threeD.singleGutter.mat01_elastic_modulus_singleGutter;
import com.js.ens.leveller.procs.threeD.singleGutter.mat02_flow_stress_const_singleGutter;
import com.js.ens.leveller.procs.threeD.singleGutter.mat02_flow_stress_singleGutter;
import com.js.ens.leveller.procs.threeD.singleGutter.mat03_thermal_expansion_const_singleGutter;
import com.js.ens.leveller.procs.threeD.singleGutter.mat03_thermal_expansion_singleGutter;
import com.js.ens.leveller.procs.threeD.singleGutter.mat04_poisson_const_singleGutter;
import com.js.ens.leveller.procs.threeD.singleGutter.mat04_poisson_singleGutter;
import com.js.ens.leveller.procs.threeD.singleGutter.mat05_mass_density_singleGutter;
import com.js.io.Reader;
import com.js.io.Writer;
import com.js.util.myUtil;

public class a3_material_define_singleGutter {
	private Logger log = Logger.getLogger(a3_material_define_singleGutter.class);
	...
	public a3_material_define_singleGutter() {
	...
	private void genMatProc() {
		...
		if(LMain.getYoungsModulusType().toLowerCase().equals("constant")){
			mat01_elastic_modulus_const_singleGutter EMObj = new mat01_elastic_modulus_const_singleGutter();
		...
		//mat01_~_const.proc
			...
			mat01_elastic_modulus_singleGutter EMObj = new mat01_elastic_modulus_singleGutter();
		...
		if(LMain.getFlowStressType().toLowerCase().equals("constant")){
			mat02_flow_stress_const_singleGutter FSObj = new mat02_flow_stress_const_singleGutter();
		...
		//mat02_~_const.proc
			...
			mat02_flow_stress_singleGutter FSObj = new mat02_flow_stress_singleGutter();
		...
		if(LMain.getThermalExpansionCoefficientType().toLowerCase().equals("constant")){
			mat03_thermal_expansion_const_singleGutter TECObj = new mat03_thermal_expansion_const_singleGutter();
		...
		//mat03_~_const.proc
			...
			mat03_thermal_expansion_singleGutter TECObj = new mat03_thermal_expansion_singleGutter();
		...
		if (LMain.getPoissonsRatioType().toLowerCase().equals("constant")) {
			mat04_poisson_const_singleGutter PObj = new mat04_poisson_const_singleGutter();
		...
		//mat04_~_const.proc
			...
			mat04_poisson_singleGutter PObj = new mat04_poisson_singleGutter();
		...
		//mat05_~proc
		mat05_mass_density_singleGutter MDObj = new mat05_mass_density_singleGutter();
