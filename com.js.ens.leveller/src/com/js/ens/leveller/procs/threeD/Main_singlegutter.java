...
import com.js.ens.leveller.procs.threeD.singleGutter.a2_roll_gen_singleGutter;
import com.js.ens.leveller.procs.threeD.singleGutter.a3_material_define_singleGutter;
import com.js.ens.leveller.procs.threeD.singleGutter.a4_contact_singleGutter;
import com.js.ens.leveller.procs.threeD.singleGutter.a6_loadcase_singleGutter;
import com.js.ens.leveller.procs.threeD.singleGutter.define_parameters_singleGutter;
import com.js.io.Reader;
import com.js.io.Writer;

public class Main_singlegutter {
	private Logger log = Logger.getLogger(Main_singlegutter.class);
	private LevellerMain LMain = LevellerMain.getInstatnce();
	
	private ArrayList<String> filePathList = new ArrayList<String>();
	private String main_singlegutter_Path 				= "";
	...
	public void running(ArrayList<String> destFullPath){
		...
		try{
			...
			LMain.getExportMSG().addData("SUCCESS - Export(main_singlegutter) \n path : "+ this.main_singlegutter_Path);
			log.info("SUCCESS - Export(main_singlegutter) \n path : "+ this.main_singlegutter_Path);
			
			this.GenOtherProcs();
		}catch(Exception e){
			String msg = "ERROR - Export(main_singlegutter)";
			msg = msg +"\n"+e.getMessage();
	...
	private void setFilesPath() throws Exception{
		for(String path : this.filePathList){
			if(path.contains("main_singlegutter.proc")){
				this.main_singlegutter_Path = path.trim();
	...
	private void readSourceData() throws Exception{
		...
		Reader reader = new Reader(this.main_singlegutter_Path);
		reader.running();
	...
	private void writeProc() throws Exception{
		Writer writer = new Writer(this.main_singlegutter_Path,this.procDataList);
		writer.running();
	}
	...
	private void GenOtherProcs(){
		...
		define_parameters_singleGutter DPObj = new define_parameters_singleGutter();
		DPObj.running(this.define_parameters_PATH);
		//a2_roll_gen.proc
		a2_roll_gen_singleGutter a2Obj = new a2_roll_gen_singleGutter();
		a2Obj.running(this.a2_roll_gen_PATH);
		//a3_material_define.proc
		a3_material_define_singleGutter a3Obj = new a3_material_define_singleGutter();
		a3Obj.running(this.a3_material_define_PATH, matsPath);
		//a4_contact.proc
		a4_contact_singleGutter a4Obj = new a4_contact_singleGutter();
		a4Obj.running(this.a4_contact_PATH);
		//a6_loadcase.proc
		a6_loadcase_singleGutter a6Obj = new a6_loadcase_singleGutter();
