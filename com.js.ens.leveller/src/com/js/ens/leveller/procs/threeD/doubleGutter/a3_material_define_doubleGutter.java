...
import com.js.ens.leveller.procs.threeD.doubleGutter.mat01_elastic_modulus_const_doubleGutter;
import com.js.ens.leveller.procs.threeD.doubleGutter.mat01_elastic_modulus_doubleGutter;
import com.js.ens.leveller.procs.threeD.doubleGutter.mat02_flow_stress_const_doubleGutter;
import com.js.ens.leveller.procs.threeD.doubleGutter.mat02_flow_stress_doubleGutter;
import com.js.ens.leveller.procs.threeD.doubleGutter.mat03_thermal_expansion_const_doubleGutter;
import com.js.ens.leveller.procs.threeD.doubleGutter.mat03_thermal_expansion_doubleGutter;
import com.js.ens.leveller.procs.threeD.doubleGutter.mat04_poisson_const_doubleGutter;
import com.js.ens.leveller.procs.threeD.doubleGutter.mat04_poisson_doubleGutter;
import com.js.ens.leveller.procs.threeD.doubleGutter.mat05_mass_density_doubleGutter;
import com.js.io.Reader;
import com.js.io.Writer;
import com.js.util.myUtil;

public class a3_material_define_doubleGutter {

	private Logger log = Logger.getLogger(a3_material_define_doubleGutter.class);
	...
	public a3_material_define_doubleGutter() {
	...
	private void genMatProc() {
		...
		if(LMain.getYoungsModulusType().toLowerCase().equals("constant")){
			mat01_elastic_modulus_const_doubleGutter EMObj = new mat01_elastic_modulus_const_doubleGutter();
		...
		//mat01_~_const.proc
			...
			mat01_elastic_modulus_doubleGutter EMObj = new mat01_elastic_modulus_doubleGutter();
		...
		if(LMain.getFlowStressType().toLowerCase().equals("constant")){
			mat02_flow_stress_const_doubleGutter FSObj = new mat02_flow_stress_const_doubleGutter();
		...
		//mat02_~_const.proc
			...
			mat02_flow_stress_doubleGutter FSObj = new mat02_flow_stress_doubleGutter();
		...
		if(LMain.getThermalExpansionCoefficientType().toLowerCase().equals("constant")){
			mat03_thermal_expansion_const_doubleGutter TECObj = new mat03_thermal_expansion_const_doubleGutter();
		...
		//mat03_~_const.proc
			...
			mat03_thermal_expansion_doubleGutter TECObj = new mat03_thermal_expansion_doubleGutter();
		...
		if (LMain.getPoissonsRatioType().toLowerCase().equals("constant")) {
			mat04_poisson_const_doubleGutter PObj = new mat04_poisson_const_doubleGutter();
		...
		//mat04_~_const.proc
			...
			mat04_poisson_doubleGutter PObj = new mat04_poisson_doubleGutter();
		...
		//mat05_~proc
		mat05_mass_density_doubleGutter MDObj = new mat05_mass_density_doubleGutter();
