...
public class define_parameters_partialGutter {
	private Logger log = Logger.getLogger(define_parameters_partialGutter.class);
	...
	public define_parameters_partialGutter() {
	...
	private void swapValue() throws Exception{
		...
		for(String line : fileDataList){
			...
			else if(line.contains(ProcMaker.type5_textGutterHeight)){
