...
public class a3_material_define_curl {
	private Logger log = Logger.getLogger(a3_material_define_curl.class);
	...
	public a3_material_define_curl() {
	...
	private void genMatProc() {
		...
		if(LMain.getYoungsModulusType_2D().toLowerCase().equals("constant")){
			mat01_elastic_modulus_const_curl EMObj = new mat01_elastic_modulus_const_curl();
		...
		//mat01_~_const.proc
			...
			mat01_elastic_modulus_curl EMObj = new mat01_elastic_modulus_curl();
		...
		if(LMain.getFlowStressType_2D().toLowerCase().equals("constant")){
			mat02_flow_stress_const_curl FSObj = new mat02_flow_stress_const_curl();
		...
		//mat02_~_const.proc
			...
			mat02_flow_stress_curl FSObj = new mat02_flow_stress_curl();
		...
		if(LMain.getThermalExpansionCoefficientType_2D().toLowerCase().equals("constant")){
			mat03_thermal_expansion_const_curl TECObj = new mat03_thermal_expansion_const_curl();
		...
		//mat03_~_const.proc
			...
			mat03_thermal_expansion_curl TECObj = new mat03_thermal_expansion_curl();
		...
		if (LMain.getPoissonsRatioType_2D().toLowerCase().equals("constant")) {
			mat04_poisson_const_curl PObj = new mat04_poisson_const_curl();
		...
		//mat04_~_const.proc
			...
			mat04_poisson_curl PObj = new mat04_poisson_curl();
		...
		//mat05_~proc
		mat05_mass_density_curl MDObj = new mat05_mass_density_curl();
