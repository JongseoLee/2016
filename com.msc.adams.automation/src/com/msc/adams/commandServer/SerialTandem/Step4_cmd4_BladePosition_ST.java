...
public class Step4_cmd4_BladePosition_ST {
	...
	public Step4_cmd4_BladePosition_ST() {
		...
		this.ori_CMDPath = myUtil.setPath(linkageFolder,cmdFileListObj.getFileName(CMDFileList.cmd4_BladePosition_ST));
		String AdamsCommand = myUtil.setPath(MC.getWorkspace(), DatabaseFolderName.AdamsCommand); 
		this.new_CMDPath = myUtil.setPath(AdamsCommand, cmdFileListObj.getFileName(CMDFileList.cmd4_BladePosition_ST));
	}
