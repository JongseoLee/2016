...
public class Step4_cmd4_Simulation_MT {
	...
	public Step4_cmd4_Simulation_MT() {
		...
		this.ori_CMDPath = myUtil.setPath(linkageFolder,cmdFileListObj.getFileName(CMDFileList.cmd4_Simulation_MT));
		String AdamsCommand = myUtil.setPath(MC.getWorkspace(), DatabaseFolderName.AdamsCommand); 
		this.new_CMDPath = myUtil.setPath(AdamsCommand, cmdFileListObj.getFileName(CMDFileList.cmd4_Simulation_MT));
	}
	...
	public void readFirstRunCMD(){
		...
		String RemovePreSimulation = myUtil.setPath(linkageFolder, cmdFileListObj.getFileName(CMDFileList.cmd4_RemovePreSimulation_MT));
