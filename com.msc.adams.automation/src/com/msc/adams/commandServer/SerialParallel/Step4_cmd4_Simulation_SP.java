...
public class Step4_cmd4_Simulation_SP {
	...
	public Step4_cmd4_Simulation_SP() {
		...
		this.ori_CMDPath = myUtil.setPath(linkageFolder,cmdFileListObj.getFileName(CMDFileList.cmd4_Simulation_SP));
		String AdamsCommand = myUtil.setPath(MC.getWorkspace(), DatabaseFolderName.AdamsCommand); 
		this.new_CMDPath = myUtil.setPath(AdamsCommand, cmdFileListObj.getFileName(CMDFileList.cmd4_Simulation_SP));
	}
	...
	public void readFirstRunCMD(){
		...
		String RemovePreSimulation = myUtil.setPath(linkageFolder, cmdFileListObj.getFileName(CMDFileList.cmd4_RemovePreSimulation_SP));
